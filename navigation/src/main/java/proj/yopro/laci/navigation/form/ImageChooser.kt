...
class FromCamera : ActivityResultContract<String, Uri?>() {
    ...
    override fun createIntent(
        ...
        imageUri = FileProvider.getUriForFile(context, "app.cicilan", image)
    ...
    override fun parseResult(
        resultCode: Int,
        intent: Intent?,
    ): Uri? = imageUri.takeIf { resultCode == Activity.RESULT_OK }
}
...
fun Context.convertCacheImageToExternalFileImage(
    cacheImageUri: Uri,
    userName: String,
): Uri {
